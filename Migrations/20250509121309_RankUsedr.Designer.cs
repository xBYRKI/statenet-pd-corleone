...
namespace statenet_lspd.Migrations
{
    ...
    [Migration("20250509121309_RankUsedr")]
    partial class RankUsedr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserRoles", null, t =>
                        {
                            t.Property("ApplicationRoleId")
                                .HasColumnName("ApplicationRoleId1");
            ...
            modelBuilder.Entity("UserUnit", b =>
                {
                    b.HasOne("statenet_lspd.Models.Unit", null)
                        .WithMany()
            ...
            modelBuilder.Entity("statenet_lspd.Models.MenuItemRole", b =>
                {
                    b.HasOne("statenet_lspd.Models.MenuItem", "MenuItem")
