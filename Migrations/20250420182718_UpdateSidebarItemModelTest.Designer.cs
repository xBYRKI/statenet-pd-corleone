...
namespace statenet_lspd.Migrations
{
    ...
    [Migration("20250420182718_UpdateSidebarItemModelTest")]
    partial class UpdateSidebarItemModelTest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("statenet_lspd.Models.SidebarItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("RoleRequiredId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("statenet_lspd.Models.UserInstructionAcceptance", b =>
                {
                    ...
                    b.Property<int>("ServiceInstructionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ServiceInstructionId");
            ...
            modelBuilder.Entity("statenet_lspd.Models.SidebarItem", b =>
                {
                    b.HasOne("statenet_lspd.Models.SidebarItem", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("statenet_lspd.Models.ApplicationRole", "RoleRequired")
                        .WithMany()
                        .HasForeignKey("RoleRequiredId");

                    b.Navigation("Parent");

                    b.Navigation("RoleRequired");
                });

            modelBuilder.Entity("statenet_lspd.Models.UserInstructionAcceptance", b =>
                {
                    b.HasOne("statenet_lspd.Models.ServiceInstruction", "Instruction")
                        .WithMany()
                        .HasForeignKey("ServiceInstructionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
