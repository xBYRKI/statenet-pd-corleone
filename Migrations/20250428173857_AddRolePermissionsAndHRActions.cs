...
{
    /// <inheritdoc />
    public partial class AddRolePermissionsAndHRActions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DiscordRoleId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    discord_id = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    prefix = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    dienstnummer = table.Column<int>(type: "int", nullable: false),
                    besoldung = table.Column<int>(type: "int", nullable: false),
                    erstellt_am = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    status = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    rangs_id = table.Column<int>(type: "int", nullable: true),
                    teams_id = table.Column<int>(type: "int", nullable: true),
                    phone = table.Column<int>(type: "int", nullable: false),
                    fired_at = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    birthday = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    birthday_message_sent = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    total_hours = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<string>(type: "enum('IN_SERVICE','OUT_OF_SERVICE','PENDING','CANCELLED')", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorHex = table.Column<string>(type: "varchar(7)", maxLength: 7, nullable: false, defaultValue: "#FFFFFF")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MinPayGrade = table.Column<int>(type: "int", nullable: false),
                    MaxPayGrade = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Degradierung = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Suspendierung = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reason = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OldRank = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NewRank = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRActions", x => x.Id);
                    table.ForeignKey(
